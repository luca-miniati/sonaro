...
sp_oauth = SpotifyOAuth(
    ...
    scope=['user-library-read', 'user-read-playback-state', 'user-read-recently-played', 'user-top-read'],
)
...
def profile():
    ...
    user_img = user_info['images'][0]['url'] if user_info['images'] else url_for('static', filename='default-profile-picture.jpeg')

    return render_template('profile.html', user_display_name=user_info["display_name"], user_img=user_img)
